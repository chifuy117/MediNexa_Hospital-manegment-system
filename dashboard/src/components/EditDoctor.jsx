...
const EditDoctor = () => {
  ...
  const availablePhotos = [
    ...
    "/dashboard/doc10.jpg",
    "/dashboard/doc.png",
    "/dashboard/docHolder.jpg"
  ];

  useEffect(() => {
    const fetchDoctor = async () => {
      try {
              const { data } = await axios.get(`/api/v1/user/doctor/${id}`);
  ...
  const handleUpdateDoctor = async (e) => {
    ...
    try {
      ...
      console.log("Sending request to:", `/api/v1/user/doctor/${id}`);
              ...
              <img
                src={
                  docAvatarPreview 
                    ...
                    : selectedPhoto 
                    ? selectedPhoto 
                                         : doctor.docAvatar?.url || "/dashboard/docHolder.jpg"
                }
                alt="Doctor Avatar"
